...
function About() {
    return (
        ...
        <div>
            ...
            <p>In my personal life, I have been married since May 11th, 2013. I have 2 daughters, a 6 year old and a 3 month old. My hobbies include personal finance, below average golf, and being a movie and television connoisseur.</p>
        </div>
        </section>
    )
}
